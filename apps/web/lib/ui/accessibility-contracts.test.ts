...
const announcementTable = readFileSync(resolve(process.cwd(), "components/announcement/announcement-table.tsx"), "utf8")
const announcementClient = readFileSync(resolve(process.cwd(), "app/[locale]/announcement/client.tsx"), "utf8")
const homeAnnouncementTable = readFileSync(resolve(process.cwd(), "components/home/home-announcement-table.tsx"), "utf8")
const resultCard = readFileSync(resolve(process.cwd(), "components/events/result-card.tsx"), "utf8")
const eventClient = readFileSync(resolve(process.cwd(), "app/[locale]/events/[slug]/client.tsx"), "utf8")
const recruitmentCard = readFileSync(resolve(process.cwd(), "components/events/recruitment-card.tsx"), "utf8")
...
const tiptapEditorShared = readFileSync(resolve(process.cwd(), "components/editor/tiptap-editor-shared.tsx"), "utf8")
...
const usersTable = readFileSync(resolve(process.cwd(), "components/admin/users-table.tsx"), "utf8")
const homeEvents = readFileSync(resolve(process.cwd(), "components/home/home-events.tsx"), "utf8")
const homeAnnouncement = readFileSync(resolve(process.cwd(), "components/home/home-announcement.tsx"), "utf8")
